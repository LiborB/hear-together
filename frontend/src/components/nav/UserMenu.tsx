        ...
        <div ref={ref} className="text-center relative w-32">
            ...
            {isComponentVisible && (
                <ul className="absolute flex flex-col justify-center w-full items-center mt-2 bg-gray-800 rounded-lg">
                    <li className="py-2 w-full text-center cursor-pointer hover:text-teal-300">My Account</li>
                    <li onClick={handleSignoutClick} className="py-2 w-full text-center cursor-pointer hover:text-teal-300">
                        Sign Out
                    </li>
                </ul>
            )}
